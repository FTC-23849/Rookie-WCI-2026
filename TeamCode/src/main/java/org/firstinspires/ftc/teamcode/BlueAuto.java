...
public class BlueAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-55.8,-43.1, Math.toRadians(225));
        ...
        TrajectoryActionBuilder scorePreloads = drive.actionBuilder(startPose)
                .strafeToSplineHeading(new Vector2d(-28,-28), Math.toRadians(230));
        ...
        TrajectoryActionBuilder prepIntake1 = drive.actionBuilder(drive.localizer.getPose())
                .strafeToSplineHeading(new Vector2d(-10,-12), Math.toRadians(270));
        ...
        TrajectoryActionBuilder Intake1 = drive.actionBuilder(drive.localizer.getPose())
                .strafeToSplineHeading(new Vector2d(-10,-55), Math.toRadians(270));
