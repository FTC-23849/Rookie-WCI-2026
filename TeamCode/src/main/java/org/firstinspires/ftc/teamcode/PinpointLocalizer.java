...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1121.9245257544064; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2306.2916428391336; // x position of the perpendicular encoder (in tick units)
    }
